...
class ConfigurationService:
    ...
    def __init__(self, base_path: Path | None = None, environment: str | None = None):
        """
    ...
    def get_connection_string(self, name: str) -> str | None:
    ...
    def get_log_level(self) -> str:
        ...
        return self.get_value("Logging:LogLevel", "Information")
