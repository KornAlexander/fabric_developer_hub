...
_register(
    AgentTemplate(
        ...
        system_prompt=(
            ...
            "work by default unless the user explicitly asks for a lower-fidelity/specific design or supplies a different sample to follow. A vague request like 'nice' or 'appropriate' is not a lower bar: require a 3-30-300 reader path, top-left KPI overview, interactive filter-and-zoom section, "
            "details on demand, scenario/navigation cues, methodology/source transparency, accessible alt text/labels/tab order/contrast, modern multi-hue styling, and no default-looking one-card report shells. Prefer delegating final Fabric acceptance checks to "
...
_register(
    AgentTemplate(
        ...
        system_prompt=(
            ...
            "unless the user explicitly asks for a low-fidelity/specific design or provides another sample whose visual language should be followed. A request for a 'nice' report still means championship-caliber work. "
            "Use the 3-30-300 pattern (3-second top-left overview, 30-second filter-and-zoom exploration, 300-second details on demand), "
            ...
            "a reader workflow from summary KPIs to distribution charts to detail tables, scenario/navigation cues, methodology/source transparency, sensible "
            "grouping/sorting, descriptive measure names, useful tooltips/custom cards, accessible alt text/labels/tab order, readable non-overlapping layout, and a modern "
...
_register(
    AgentTemplate(
        ...
        system_prompt=(
            ...
            "visual clarity, information hierarchy, metric semantics, IBCS/style hygiene, UI/UX usability, interactions/tooltips, methodology/source transparency, Power BI Data Stories/world-championship usefulness, "
...
_register(
    AgentTemplate(
        ...
        system_prompt=(
            ...
            "NO_BROWSER_SCREENSHOT_EVIDENCE, REPORT_STUCK_LOADING, BROWSER_ERROR_OBSERVED, or VISUALS_NOT_RENDERED if browser evidence is missing or "
            ...
            "* You may use 'PASSED' in the first sentence ONLY when (a) browser evidence exists with screenshotPath, (b) bodyTextSample does NOT "
            "  contain any of the loading-stuck phrases, (c) there are no error modals, (d) at least one visible visual-like "
            "  element rendered, (e) the artifact matches the user's original task, and (f) the strict quality review covers the report's UI/UX/design/usability.\n"
            ...
            "design/usability, information hierarchy, interactions/tooltips, championship/3-30-300 storytelling, accessibility, methodology/source transparency, default-or-requested style, naming convention fit, semantic model, data/code quality, "
