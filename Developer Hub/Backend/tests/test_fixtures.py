...
class TestFixtures:
    ...
    # Test item types
    ITEM_TYPE = "Org.AgentHub.AgentHubItem"
...
class AuthenticationTestFixtures:
    ...
    def create_jwt_payload(
        ...
        scopes: str | None = "FabricWorkloadControl",  # Default scope for delegated tokens
        id_typ: str | None = None,
    ...
    def get_authentication_service():
        ...
        with patch("services.auth.authentication.get_configuration_service", return_value=mock_config_service):
            with patch("services.auth.authentication.msal"):
